                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" style="color:#a0aec0;font-size:14px;padding:10px 0">
                                            Таны эрхээр {{ $data['ip'] }} хаягтай төхөөрөмж нэвтрэх гэж байна! Та
                                            дараах холбоост хандаж, төхөөрөмж баталгаажуулалт хийнэ үү.
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <div
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="3">
                                                                <a href="{{ $data['hostname'] }}/confirm-device/{{ $data['token'] }}"
