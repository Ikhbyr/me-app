    ...
    new Vue({
        ...
        methods: {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('{{ \App\Services\LaravelWebSockets\src\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('{{ \App\Services\LaravelWebSockets\src\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}statistics')
